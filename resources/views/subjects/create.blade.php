...
<div class="max-w-2xl mx-auto">
    <div class="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
        <div class="p-8 border-b border-gray-50 bg-gray-50/50">
            <h3 class="text-2xl font-extrabold text-[#032e5e]">Nueva Materia</h3>
        ...
        <form action="{{ route('subjects.store') }}" method="POST" class="p-8 space-y-6">
            ...
            <div>
                ...
                <textarea name="description" rows="4" placeholder="Breve resumen de los contenidos..." 
                    class="w-full px-6 py-4 rounded-2xl bg-gray-50 border-2 border-transparent focus:border-[#032e5e]/10 focus:bg-white outline-none transition-all font-semibold text-gray-700">{{ old('description') }}</textarea>
