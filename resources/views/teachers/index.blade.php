...
<div class="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
    <div class="p-8 border-b border-gray-50 flex flex-col md:flex-row justify-between items-center bg-gray-50/50 gap-4">
        <div>
            <h3 class="text-2xl font-extrabold text-[#032e5e]">Docentes</h3>
            <p class="text-gray-500 font-semibold mt-1">Gestión del personal académico y asignaciones de aula.</p>
        </div>
        <a href="{{ route('teachers.create') }}" class="px-8 py-3 bg-[#032e5e] text-white rounded-2xl font-bold hover:bg-[#032e5e]/90 transition-all shadow-lg shadow-[#032e5e]/20 flex items-center">
                ...
                <tbody class="divide-y divide-gray-50">
                    ...
                    <tr class="hover:bg-gray-50/50 transition-colors group">
                        ...
                        <td class="px-6 py-5">
                            ...
                            @endphp
                            @if($assignment)
                                <span class="px-4 py-1.5 bg-orange-50 text-[#c56c39] rounded-full text-[10px] font-black uppercase tracking-widest border border-orange-100">
                        ...
                        <td class="px-6 py-5 text-right space-x-2">
                            <a href="{{ route('teachers.show', $teacher->id) }}" class="text-[#032e5e] hover:text-[#032e5e]/80 font-bold text-xs uppercase tracking-widest">Ver Perfil</a>
                            <a href="{{ route('teachers.edit', $teacher->id) }}" class="text-gray-400 hover:text-[#c56c39] font-bold text-xs uppercase tracking-widest">Editar</a>
                        </td>
                    </tr>
                    @empty
                    <tr>
