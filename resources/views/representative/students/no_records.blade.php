...
<div class="max-w-2xl mx-auto py-12">
    <div class="bg-white p-12 rounded-[3rem] shadow-sm border border-gray-100 text-center space-y-8">
        <div class="w-24 h-24 bg-blue-50 rounded-[2rem] flex items-center justify-center mx-auto text-blue-500">
        ...
        <div class="space-y-4">
            <h3 class="text-3xl font-black text-[#032e5e]">Récord Académico No Disponible</h3>
        ...
        <div class="pt-4">
            <a href="{{ route('representative.students.index') }}" class="inline-block px-10 py-5 bg-[#032e5e] text-white rounded-2xl font-black text-xs uppercase tracking-[0.2em] shadow-xl shadow-[#032e5e]/20 hover:scale-[1.02] transition-all">
                Volver a Mis Hijos
            </a>
        </div>
    </div>
