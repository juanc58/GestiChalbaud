...
<div class="max-w-full space-y-6">
    ...
    <div class="mb-8">
        <div class="flex items-center gap-3 mb-2">
            <a href="{{ route('representative.students.index') }}" class="flex items-center justify-center w-10 h-10 rounded-xl bg-[#D32F2F]/10 hover:bg-[#D32F2F]/20 transition-colors group" title="Cancelar y volver">
            ...
            <h3 class="text-2xl font-extrabold text-[#1A237E]">Inscribir Hijo(a)</h3>
        </div>
        <p class="text-gray-500 font-semibold text-sm mt-1">Completa la ficha paso a paso. Un administrador le asignará la sección luego de revisar los datos.</p>
    </div>
    ...
    <form action="{{ route('representative.students.store') }}" method="POST" id="student-form" class="space-y-8">
        @csrf
        <input type="hidden" name="is_historical_graduate" value="0">
        ...
        <div class="flex items-center justify-between mt-8">
            <div class="flex items-center gap-4">
                <a href="{{ route('representative.students.index') }}" class="px-8 py-4 rounded-2xl font-bold bg-[#D32F2F] text-white hover:bg-[#D32F2F]/90 transition-all shadow-lg shadow-[#D32F2F]/20 flex items-center gap-2">
