            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="group space-y-2 md:col-span-2">
                    ...
                    <input type="text" name="security_answer" placeholder="Restablecer respuesta del usuario..." autocomplete="off"
                        class="w-full px-5 py-4 rounded-2xl bg-amber-50/50 border-2 border-transparent focus:border-amber-200 outline-none transition-all font-bold text-[#032e5e]">
                </div>
            </div>
        </div>
