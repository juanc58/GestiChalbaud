...
<div class="max-w-4xl mx-auto space-y-8">
    <div class="flex items-center justify-between">
        <div>
            <h3 class="text-2xl font-extrabold text-[#032e5e]">Editar Ficha de Representante</h3>
    ...
    <form action="{{ route('representatives.update', $representative->id) }}" method="POST" class="space-y-6">
        ...
        <div class="bg-white p-8 rounded-[2.5rem] shadow-sm border border-gray-100 space-y-6">
            <h4 class="text-xs font-black text-[#032e5e] uppercase tracking-widest flex items-center mb-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="group space-y-2">
                    ...
                    <input type="text" name="phone_whatsapp" value="{{ old('phone_whatsapp', $representative->phone_whatsapp) }}" required
                        class="w-full px-5 py-4 rounded-2xl bg-gray-50 border-2 border-transparent focus:border-[#c56c39]/20 outline-none transition-all font-bold text-[#032e5e]">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="group space-y-2">
                    ...
                    <input type="text" name="job_title" value="{{ old('job_title', $representative->job_title) }}"
                        class="w-full px-5 py-4 rounded-2xl bg-gray-50 border-2 border-transparent focus:border-green-200 outline-none transition-all font-bold text-[#032e5e]">
                </div>
